...
class ngoaiTroi extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return ngoaiTroi_state();
  }
...
class ngoaiTroi_state extends State<ngoaiTroi>{
                          ...
                          itemBuilder: (context, indext) {
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  child: Image.asset('assets/image/ngoaiTroi/$tenfile.png')
                              ),
                            );
                          })),
                ),
  ...
  void PhatAmThanh() {
    if (!statusTatAm){
      ...
      if (statusGiongBac){
        player.play(AssetSource('audio/ngoaiTroi/giongBac/$tenfile.m4a'));
      }else{
        player.play(AssetSource('audio/ngoaiTroi/giongNam/$tenfile.mp3'));
      }
    }
  }
